...
import json
import reflex as rx
from chat.chat_GPT_manager import ChatGPTAgent
...
""",
    ...
    async def openai_process_question(self, question: str):
        ...
        response = agent.response_from_chat_GPT_with_chain_of_reasoning(analysis_depth=load_config()["analysis_depth"], user_message=question, images=[], preserve_user_messages_post_analysis=True)
